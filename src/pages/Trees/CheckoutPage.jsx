...
const CheckoutPage = () => {
    ...
    const totalPrice = cartItems.reduce(
        (acc, item) => acc + item.newPrice * item.quantity,0
    );    
        ...
        <section>
            <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
                <div className="container max-w-screen-lg mx-auto">
                    <div>
                        <div>
                            <h2 className="font-semibold text-xl text-gray-600 mb-2">Thanh toán tiền mặt</h2>
                            <p className="text-gray-500 mb-2">Tổng: {formatVND(totalPrice)}</p>
                            ...
                            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                                    <div className="text-gray-600">
                                        ...
                                        <p>Vui lòng điền đầy đủ thông tin vào tất cả các trường.</p>
                                    </div>
                                    ...
                                    <div className="lg:col-span-2">
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-5">
                                                <label html="email">Địa chỉ Email:</label>
                                                <input
