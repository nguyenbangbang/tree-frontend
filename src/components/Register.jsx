    ...
    <div className='h-[calc(100vh-120px)] flex justify-center items-center '>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    <button  className="bg-green-600 hover:bg-green-700 text-white text-sm py-1 px-2 rounded-md flex items-center gap-1 w-fit transition-colors duration-200">Đăng ký</button>
                </div>
            </form>
            <p className='align-baseline font-medium mt-4 text-sm'>Nếu  có tài khoản, <Link to="/login" className='text-green-500 hover:text-green-700'>Đăng nhập</Link></p> 
